...
export default class TalentMatching extends React.Component {
    ...
    //loadJobs(data) { // url: 'http://talentservicestalent.azurewebsites.net/listing/listing/getEmployerJobs',
        
    //loadSelectedJob(data) url: 'http://talentservicestalent.azurewebsites.net/listing/listing/getJobForTalentMatching',

    //loadTalentList()  url: 'http://talentservicesprofile.azurewebsites.net/profile/profile/getTalentList',

    //loadTalentFilterList() //url: 'http://talentservicesprofile.azurewebsites.net/profile/profile/getTalentListFilter',

    //loadEmployerFilterList() //url: 'http://talentservicesprofile.azurewebsites.net/profile/profile/getEmployerListFilter',


    // loadEmployerList() // url: 'http://talentservicesprofile.azurewebsites.net/profile/profile/getEmployerList',
    //loadSuggestionList   url: 'http://talentservicesprofile.azurewebsites.net/profile/profile/getSuggestionList',

   // saveCompanyTalents()   url: 'http://talentservicesprofile.azurewebsites.net/profile/profile/addTalentSuggestions',
     

    //saveJobTalents()    url: 'http://talentservicesprofile.azurewebsites.net/profile/profile/addTalentSuggestions',
